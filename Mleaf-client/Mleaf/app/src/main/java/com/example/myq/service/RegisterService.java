...
public class RegisterService {
    private static String IP = "111.114.116.28:8080";

    // 通过 POST 方式获取HTTP服务器数据
    public static String executeHttpPost(String phonenumber,String password) {

        try {
            String path = "http://" + IP + "/Mleaf/RegisterServlet";
